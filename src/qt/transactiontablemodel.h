...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, OwnCrewUnits::SeparatorStyle separators=OwnCrewUnits::SeparatorStyle::STANDARD) const;
