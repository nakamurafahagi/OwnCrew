...
//! Entry point for OwnCrewApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &OwnCrewApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for OwnCrewGUI tests.
void AppTests::guiTests(OwnCrewGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &OwnCrewGUI::consoleShown, this, &AppTests::consoleTests);
