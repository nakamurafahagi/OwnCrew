...
{
    // Test regression https://github.com/owncrew/owncrew/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/owncrew-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/owncrew-core/gui/pull/568.
    // With fListen=false in ~/.config/OwnCrew/OwnCrew-Qt.conf and all else left as default,
    // owncrew-qt should set both -listen and -listenonion to false and start successfully.
