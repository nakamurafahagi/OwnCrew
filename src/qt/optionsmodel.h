...
/** Interface from Qt to configuration data structure for OwnCrew client.
...
public:
    ...
    OwnCrewUnit getDisplayUnit() const { return m_display_owncrew_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSOWControls() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    OwnCrewUnit m_display_owncrew_unit;
...
Q_SIGNALS:
    void displayUnitChanged(OwnCrewUnit unit);
