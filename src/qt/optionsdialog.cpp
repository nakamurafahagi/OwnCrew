      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->owncrewAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->owncrewAtStartup);
    ...
    ui->owncrewAtStartup->setToolTip(ui->owncrewAtStartup->toolTip().arg(CLIENT_NAME));
    ui->owncrewAtStartup->setText(ui->owncrewAtStartup->text().arg(CLIENT_NAME));

    ui->openOwnCrewConfButton->setToolTip(ui->openOwnCrewConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new OwnCrewUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->owncrewAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSOWControls);
...
void OptionsDialog::on_openOwnCrewConfButton_clicked()
{
