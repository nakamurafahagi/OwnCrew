...
const std::string CURRENCY_UNIT = "OWC"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    OWC_KVB,      //!< Use OWC/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::OWC_KVB) const;
