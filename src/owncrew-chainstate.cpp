...
//
// The owncrew-chainstate executable serves to surface the dependencies required
// by a program wishing to use OwnCrew Core's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from OwnCrew Core's coding style.
//
// It is part of the libowncrewkernel project.
