...
static RPCHelpMan waitfornewblock()
{
    return RPCHelpMan{"waitfornewblock",
                ...
                "\nMake sure to use no RPC timeout (owncrew-cli -rpcclienttimeout=0)",
                {
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{"scanblocks",
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (owncrew-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCHelpMan getdescriptoractivity()
{
    return RPCHelpMan{"getdescriptoractivity",
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (owncrew-cli -rpcclienttimeout=0)",
        {
    ...
    const std::function<void()>& interruption_point)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/owncrew/owncrew/pull/15606#discussion_r274479369
        //
        AssertLockHeld(::cs_main);
    ...
    const std::function<void()>& interruption_point)
{
    ...
    // See also https://github.com/owncrew/owncrew/issues/25675
