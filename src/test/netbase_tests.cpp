...
{
    BOOST_CHECK(TestSplitHost("www.owncrewcore.org", "www.owncrewcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.owncrewcore.org]", "www.owncrewcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.owncrewcore.org:80", "www.owncrewcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.owncrewcore.org]:80", "www.owncrewcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.owncrewcore.org:65536", "www.owncrewcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.owncrewcore.org:0", "www.owncrewcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.owncrewcore.org:", "www.owncrewcore.org:", 0, false));
}
