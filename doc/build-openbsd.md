...
This guide describes how to build owncrewd, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/owncrew/depends/*-unknown-openbsd*
```
...
(see issue [#6658](https://github.com/owncrew/owncrew/issues/6658)).
