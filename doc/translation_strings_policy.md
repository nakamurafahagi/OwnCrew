...
This document provides guidelines for internationalization of the OwnCrew Core software.
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `owncrew_en.ts` remains unchanged.
