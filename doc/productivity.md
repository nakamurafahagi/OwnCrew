...
```sh
cmake --build build --target owncrewd owncrew-cli
cmake --build build --target owncrew-qt
cmake --build build --target bench_owncrew
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:owncrew/owncrew.git
```
