OwnCrew Core version 0.9.4 is now available from:

  https://owncrew.org/bin/0.9.4/
...
this update is incompatible with the OwnCrew system and could lead to consensus
forks.

OwnCrew Core released binaries from https://owncrew.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~owncrew/+archive/ubuntu/owncrew
- A third-party or self-compiled OwnCrew Core

upgrade to OwnCrew Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
