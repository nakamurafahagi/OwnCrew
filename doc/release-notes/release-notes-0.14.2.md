OwnCrew Core version 0.14.2 is now available from:

  <https://owncrew.org/bin/owncrew-core-0.14.2/>
...
(in OwnCrew Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate owncrew-config.h as necessary (theuni)
