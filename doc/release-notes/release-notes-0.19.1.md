...
OwnCrew Core version 0.19.1 is now available from:

  <https://owncrewcore.org/bin/owncrew-core-0.19.1/>
...
From OwnCrew Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as OwnCrew Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, OwnCrew Core does not yet change appearance when
...
- #17488 fix "owncrewd already running" warnings on macOS (fanquake)
