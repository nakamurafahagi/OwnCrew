OwnCrew Core version 0.16.1 is now available from:

  <https://owncrewcore.org/bin/owncrew-core-0.16.1/>
...
- #12843 `df38b13` Test starting owncrewd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure owncrewd processes are cleaned up when tests end (sdaftuar)
