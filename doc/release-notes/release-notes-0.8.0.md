OwnCrew-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/owncrew/files/OwnCrew/owncrew-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the OwnCrew
...
New/changed settings (command-line or owncrew.conf file)
--------------------------------------------------------
