OwnCrew Core version 0.13.2 is now available from:

  <https://owncrew.org/bin/owncrew-core-0.13.2/>
...
- #8908 `4a974b2` Update owncrew-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow owncrew-tx to create v2 transactions (owcdrak)
