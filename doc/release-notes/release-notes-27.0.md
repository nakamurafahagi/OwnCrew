OwnCrew Core version 27.0 is now available from:

  <https://owncrewcore.org/bin/owncrew-core-27.0/>
...
- libowncrewconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libowncrewkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build OwnCrew Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of OwnCrew Core would
