OwnCrew Core version 0.10.4 is now available from:

  <https://owncrew.org/bin/owncrew-core-0.10.4/>
...
- #6953 `43c2789` Split owncrew-tx into its own package
- #6953 `dfe0d4d` Include owncrew-tx binary on Debian/Ubuntu
