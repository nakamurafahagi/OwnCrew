Download URL: https://sourceforge.net/projects/owncrew/files/OwnCrew/owncrew-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 OWC fee schedule (users still pay 0.01 OWC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #owncrew00 - #owncrew99
