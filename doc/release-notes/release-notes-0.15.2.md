OwnCrew Core version *0.15.2* is now available from:

  <https://owncrewcore.org/bin/owncrew-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in owncrew-tx (TheBlueMatt)
