OwnCrew Core version 0.9.2.1 is now available from:

  https://owncrew.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 OWC to 0.01 OWC
...
- Fix "Start owncrew on system login"
