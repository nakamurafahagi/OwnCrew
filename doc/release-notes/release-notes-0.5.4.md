OwnCrew version 0.5.4 is now available for download at:
http://sourceforge.net/projects/owncrew/files/OwnCrew/owncrew-0.5.4/
...
http://gitorious.org/owncrew/owncrewd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix OwnCrew-Qt notifications under Growl 1.3.
Increase required age of OwnCrew-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxOwnCrew properly when installing OwnCrew-Qt over it. (Windows)
