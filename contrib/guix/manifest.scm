...
(define* (make-owncrew-cross-toolchain target
                                       #:key
...
desirable for building OwnCrew Core release binaries."
...
;; failure; see https://github.com/owncrew/owncrew/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-owncrew-cross-toolchain target)))
