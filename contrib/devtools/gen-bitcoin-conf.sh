...
BITCOIND=${BITCOIND:-$BINDIR/owncrewd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/owncrew.conf}
...
then
  ...
  echo -e "To safely generate a owncrew.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example owncrew.conf file in share/examples/'
...
##
## owncrew.conf configuration file.
## Generated by contrib/devtools/gen-owncrew-conf.sh.
##
...
# parse the output from owncrewd --help
