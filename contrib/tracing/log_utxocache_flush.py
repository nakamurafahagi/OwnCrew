...
"""Example logging OwnCrew Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/owncrewd
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[owncrewd_with_usdts])
