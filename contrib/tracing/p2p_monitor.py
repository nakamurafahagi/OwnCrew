#!/usr/bin/env python3
# Copyright (c) 2021 The OwnCrew Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

""" Interactive owncrewd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for OwnCrew Core can enable. It uses BCC
...
def main(pid):
    ...
    owncrewd_with_usdts.enable_probe(
