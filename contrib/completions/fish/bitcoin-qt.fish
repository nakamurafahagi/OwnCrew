...
complete --command owncrew-qt --no-files

# Extract options
function __fish_owncrewqt_get_options
...
complete \
    --command owncrew-qt \
    --arguments "(__fish_owncrewqt_get_options --nofiles)"
