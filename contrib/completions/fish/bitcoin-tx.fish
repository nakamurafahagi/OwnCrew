...
# Extract options
function __fish_owncrew_tx_get_options
...
# Extract commands
function __fish_owncrew_tx_get_commands
...
complete \
    --command owncrew-tx \
    --condition "not __fish_owncrew_seen_cmd (__fish_owncrew_tx_get_commands --commandsonly)" \
    --arguments "(__fish_owncrew_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command owncrew-tx \
    --arguments "(__fish_owncrew_tx_get_commands)" \
    --no-files
