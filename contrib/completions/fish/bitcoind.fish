...
complete --command owncrewd --no-files

# Extract options
function __fish_owncrewd_get_options
...
complete \
    --command owncrewd \
    --arguments "(__fish_owncrewd_get_options --nofiles)"
