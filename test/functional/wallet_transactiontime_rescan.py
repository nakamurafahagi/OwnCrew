...
class TransactionTimeRescanTest(OwnCrewTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine OWC and create transactions
        ...
        # generate some owc to create transactions and check blockcount
        ...
        # send 10 owc to user's first watch-only address
        self.log.info('Send 10 owc to user')
        ...
        # send 5 owc to our second watch-only address
        self.log.info('Send 5 owc to user')
        ...
        # send 1 owc to our third watch-only address
        self.log.info('Send 1 owc to user')
