...
# The block reward of coinbaseoutput.nValue (50) OWC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 OWC/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"owncrew-cli -h\" for help or \"owncrew-cli listwallets\" to see "
...
class TestOwnCrewCli(OwnCrewTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `owncrew-cli getblockchaininfo`")
        ...
        # Prevent owncrew-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and owncrew-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and owncrew-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (OWC/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (OWC/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 OWC) to the default wallet.
            ...
            # Test owncrew-cli -generate with -rpcwallet in multiwallet mode.
