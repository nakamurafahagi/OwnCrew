...
By default, owncrewd will dump mempool on shutdown and
...
class MempoolPersistTest(OwnCrewTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent owncrewd from writing mempool.dat to disk. Verify that `savemempool` fails")
