...
"""
Test starting owncrewd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(OwnCrewTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that owncrewd has bound on "::1" (for RPC) and "::" (for P2P).
