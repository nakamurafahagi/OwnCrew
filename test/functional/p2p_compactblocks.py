...
# TestP2PConn: A peer we use to send messages to owncrewd, and store responses.
...
class CompactBlocksTest(OwnCrewTestFramework):
    ...
    # This test actually causes owncrewd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that owncrewd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for owncrewd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # owncrewd will not send blocktxn responses for blocks whose height is
