...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the OwnCrewTestFramework
    pass


class ExampleTest(OwnCrewTestFramework):
    # Each functional test is a subclass of the OwnCrewTestFramework class.
    ...
    def custom_method(self):
        ...
        OwnCrewTestFramework class so other tests can use it."""
