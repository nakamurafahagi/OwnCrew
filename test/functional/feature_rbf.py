...
class ReplaceByFeeTest(OwnCrewTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.hash}; new feerate 0.00300000 OWC/kvB <= old feerate 0.00300000 OWC/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 OWC - so this attempt is rejected.
