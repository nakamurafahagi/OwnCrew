#!/usr/bin/env python3
# Copyright (c) 2018-2021 The OwnCrew Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting owncrew with -h works as expected."""

from test_framework.test_framework import OwnCrewTestFramework
from test_framework.util import assert_equal

class HelpTest(OwnCrewTestFramework):
    ...
    def run_test(self):
        self.log.info("Start owncrew with -h for help text")
        ...
        self.log.info("Start owncrew with -version for version information")
        ...
        self.log.info("Start owncrewd with -fakearg to make sure it does not start")
