...
class InvalidAddressErrorMessageTest(OwnCrewTestFramework):
    ...
    def test_validateaddress(self):
        ...
        assert_raises_rpc_error(-1, "Return information about the given owncrew address.", node.validateaddress)
