...
Verify that a owncrewd node can use an external signer command.
...
class RPCSignerTest(OwnCrewTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart owncrewd with -signer=<cmd>',
