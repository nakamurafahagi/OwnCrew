#!/usr/bin/env python3
# Copyright (c) 2020-present The OwnCrew Core developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The owncrewd node closes feeler connections as soon as a version
...
class P2PAddConnections(OwnCrewTestFramework):
    ...
    def run_test(self):
        ...
        # owncrewd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that owncrewd sends its own version prior to processing
