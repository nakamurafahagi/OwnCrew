...
class RawTransactionsTest(OwnCrewTestFramework):
    ...
    def getrawtransaction_verbosity_tests(self):
        ...
        # Do this with a pruned chain, as a regression test for https://github.com/owncrew/owncrew/pull/29003
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid OwnCrew address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 OWC/kvB
        ...
        # Fee rate is 0.20000000 OWC/kvB
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/owncrew/owncrew/issues/20579)
