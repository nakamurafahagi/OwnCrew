#!/usr/bin/env python3
# Copyright (c) 2015-2021 The OwnCrew Core developers
...
class InvalidMessagesTest(OwnCrewTestFramework):
    ...
    def test_addrv2(self, label, required_log_messages, raw_addrv2):
        ...
        # Make sure owncrewd signals support for ADDRv2, otherwise this test
