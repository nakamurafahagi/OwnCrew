...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/owncrew/owncrew/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(OwnCrewTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our owncrewd node")
