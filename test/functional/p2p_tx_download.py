#!/usr/bin/env python3
# Copyright (c) 2019-2021 The OwnCrew Core developers
...
class TxDownloadTest(OwnCrewTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new owncrewd instances, as setting mocktimes has long-term effects on when
