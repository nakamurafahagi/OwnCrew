...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/owncrew/owncrew/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(OwnCrewTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/owncrew/owncrew/blob/master/doc/tracing.md#tracepoint-validationblock_connected
