...
class TestShell:
    """Wrapper Class for OwnCrewTestFramework.

    The TestShell class extends the OwnCrewTestFramework
    ...
    class __TestShell(OwnCrewTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by OwnCrewTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # OwnCrewTestFramework instances are supposed to be constructed with the path
