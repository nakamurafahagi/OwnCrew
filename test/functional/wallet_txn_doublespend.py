...
class TxnMallTest(OwnCrewTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 OWC:
        ...
        # First: use raw transaction API to send 1240 OWC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 OWC coin each
        ...
        # Node0's balance should be starting balance, plus 50OWC for another
        ...
        # Node0's total balance should be starting balance, plus 100OWC for
