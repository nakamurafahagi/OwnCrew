...
```sh
DOCKER_BUILDKIT=1 docker build -t owncrew-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/owncrew -it owncrew-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/owncrew-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/owncrew-core/leveldb-subtree.git (branch owncrew-fork)
* for `src/crypto/ctaes`: https://github.com/owncrew-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/owncrew-core/crc32c-subtree.git (branch owncrew-fork)
* for `src/minisketch`: https://github.com/sipa/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/owncrew-core/secp256k1.git
```
