...
# Copyright 2016-2017 The OwnCrew Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for owncrew utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "owncrew-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./owncrew-util":
        execprog = os.getenv("BITCOINUTIL", default=execprog)
    elif testObj["exec"] == "./owncrew-tx":
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, owncrew-tx
